...
if(X11)
	if(APPLE)
		...
		if(X11_FOUND)
			...
			message(WARNING "X11, Xrandr and/or Xfixes library not found")
		endif()
	else()
		...
		if(X11_FOUND)
			...
			if(GLX_FOUND)
				...
				message(WARNING "GLEW, OpenGL and or Xrender library not found")
			endif()
			...
			if(EGL_FOUND)
				...
				message(WARNING "EGL and or GLESv2 library not found")
			endif()
		else()
			message(WARNING "X11, Xrandr and/or Xfixes library not found")
		endif()
